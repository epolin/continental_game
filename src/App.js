...
function App() {
  ...
  const addPlayer = async () => {
    ...
    const response = await fetch('https://continental-game.onrender.comapi/register', {
      method: 'POST',
  ...
  useEffect(() => {
    const fetchPlayers = async () => {
      const response = await fetch('https://continental-game.onrender.comapi/players');
      const data = await response.json();
      setPlayers(data.players);
    };
    fetchPlayers();
  ...
  const submitScores = async () => {
    ...
    const response = await fetch('https://continental-game.onrender.comapi/scores', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
  ...
  const manageChips = async () => {
    ...
    const response = await fetch('https://continental-game.onrender.comapi/chips', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
